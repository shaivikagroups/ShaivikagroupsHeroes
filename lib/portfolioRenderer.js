...
function generateResumeUrls(employee) {
    const rawUrl = safeUrl(employee.resumeUrl);
    ...
    if (rawUrl.includes('cloudinary.com')) {
        ...
        // Inject fl_attachment for the download URL
        ...
        // Handle DOC/DOCX view via Google Docs (browsers can't natively render them)
        // If the URL ends with .doc or .docx (or lacks .pdf), we route through Google Docs preview.
        // Assuming non-PDF raw files need Google Docs Viewer (or at least it's safer).
