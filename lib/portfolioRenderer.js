...
const TECH_ICONS = {
    ...
    react: '⚛️', 'node.js': '🟢', nodejs: '🟢', express: '🚂',
    html: '🌐', css: '🎨', mongodb: '🍃', postgresql: '🐘',
    mysql: '🗄️', firebase: '🔥', docker: '🐳', kubernetes: '☸️',
    aws: '☁️', gcp: '☁️', azure: '☁️', git: '🌿',
    flutter: '💙', dart: '🎯', 'c++': '⚙️', c: '⚙️',
    rust: '🦀', go: '🐹', php: '🐘', ruby: '💎',
    ...
    vue: '💚', angular: '🔴', svelte: '🧡', next: '▲',
    'next.js': '▲', tailwind: '💨', figma: '🎨', xd: '🎨',
    sketch: '✏️', blender: '🎨', unity: '🎮', 'unreal engine': '🎮',
    blockchain: '⛓️', solidity: '💎', ethereum: '💎', linux: '🐧',
    bash: '💻', powershell: '💙', redis: '🔴', elasticsearch: '🔍',
};
...
<body>
    ...
    <footer class="pg-footer" role="contentinfo">
        ...
        <p class="pg-footer-copy">&copy; ${new Date().getFullYear()} Shaivika Groups. All rights reserved.</p>
    </footer>
